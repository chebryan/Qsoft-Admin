   ...
   <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Dimension Limited Admin V1.6</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
         <div class="row">
                ...
                <div class="col-lg-8">
                 <h1 class="page-header">Best Messaging API Subscription</h1>
                    <div class="panel panel-default">

                        <div class="panel-heading">
                           Use Best Messaging API to subscribe users directly from Dimension Server.. Simply Enter the Tag and Keyword and the subscription will proceed. #ThirdPartySubscription
                        </div>
                         <div class="panel-body">
                            
                             <form action="best_messaging.php" method="GET" class="form-horizontal">
                             <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Enter Keyword to use</label>
                                <div class="col-sm-8">
                                  <input class="form-control" name="d1" id="d1" placeholder="love, DailyNews, news" type="text" >
                                </div>
                              </div>
                                <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Tag generated </label>
                                <div class="col-sm-8">
                                  <input class="form-control" name="d2" id="d2" placeholder="Generate first then select from the right column" type="text" >
                                </div>
                              </div>
                               <div class="form-group">
                                  ...
                                  <?php
                                       ...
                                       // include_once 'connect.php';
                                        if (isset($_GET['subscribe'])) {
                                          ...
                                          if (isset($_GET["d1"])) { $keyword = $_GET["d1"]; } else { $keyword=0; }; 
                                           if (isset($_GET["d2"])) { $tag = $_GET["d2"]; } else { $tag=0; }; 
                                          
                                          if ($tag==0||$keyword==0) {
                                            ?>
                                            <div class="alert alert-info" role="alert">Using these Details to subscribe Keyword:<span class="label label-success"> <?php echo $keyword; ?> </span> and Tag: <span class="label label-success">  <?php echo $tag;?> </span></div>
                                            <?php
                                        ...
                                        //echo "News Subscription Sent----->".$row['gen_number']." count ID--->".$countno;
                                           ...
                                           <div class="alert alert-success" role="alert">Encountered an error while sending<?php   $e->getMessage(); ?></div>
                                            <?php
                                             ...
                                             ?>
                                           <div class="alert alert-success" role="alert">Sucessfully subcribed <span class="badge"> <?php echo $counter; ?> </span> Numbers</div>
                                            <?php
                                            }
                                          }
