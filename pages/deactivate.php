                        ...
                        <div class="panel-heading">
                         ...
                         <div class="panel-body">
                             ...
                             <div class="form-group">
                                ...
                                <input  name="d1" id="d1" placeholder="254728444666" type="text" >
                             </div>
                             <div class="form-group">
                                 <input type="submit" name="submit" id="submit" value="Search" >
                                  ...
                                  <?php
                                            ...
                                            if (isset($_GET["d1"])) { $phonenumber  = $_GET["d1"]; } else { $phonenumber=0; }; 
                                                $sql = $dbh->prepare("SELECT  * FROM tbl_totalsubscribers WHERE total_phoneno=:phone");
                                                ...
                                                if ($data) {
                                                     $ret = '<div class="col-lg-12">';
                                                      $ret .= '<table class="table graduation" id ="graduation"><thead>';
                                                      $ret .= '<tr><th>## </th><th>PhoneNumber</th><th>Keyword</th><th>Time</th><th>status</th> <th> Action</th></tr>';
                                                      $ret .= '</thead><tbody>';
                                                  foreach ($data as $row) {
                                                    $id = $row ['total_id'];
                                                    $phone = $row['total_phoneno'];
                                                    $key = $row['total_keyword'];
                                                   ...
                                                   $ret .= '<td>'.$key.'</td>';
                                                   $ret .= '<td>'.$time.'</td>';
                                                   $ret .= ($status == '0') ? '<td id="sts"><span id="1" class="label label-success">Active</span></td>' : '<td id="sts"><span id="0" class="label label-warning">Not Active</span></td>';
                                                   $ret .= ($status == '0') ? '<td><a id="' . $id . '" id-phone = "'.$phone.'" id-keyword = "'.$key.'" class="btn act" href="javascript:;">Deactivate</a></td>' : '<td><a id="' . $id . '" id-phone = "'.$phone.'" id-keyword = "'.$key.'"  class="btn act" href="javascript:;">Activate</a></td> </tr>';
