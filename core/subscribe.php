...
//14. Bible Stuff
$keyword_BIBLE = 'bible';
$subscribeMessage_BIBLE = "Welcme to the Latest Breaking News Content Provider. Get Breaking news as they unfold";
$unsubscribeMessage_BIBLE ="You have been unsubscribed from News updates Alerts";


################################################# END END of Variables Declaration and Definition ################################################
...
################################################# END END of JB Keyword ################################################

############################################### START of CASH Keyword ##################################################### 
...
################################################# END END of CASH Keyword ################################################

############################################### START of KENYA Keyword ##################################################### 
...
################################################# END END of FM Keyword ################################################

############################################### START of PENZI Keyword ##################################################### 
...
################################################# END END of PENZI Keyword ################################################

############################################### START of LOVE Keyword ##################################################### 
...
################################################# END END of LOVE Keyword ################################################

############################################### START of SHULE Keyword ##################################################### 
...
################################################# END END of SHULE Keyword ################################################

############################################### START of NEWS Keyword ##################################################### 
...
################################################# END END of BIBLE Keyword ################################################

############################################### START of JJ Keyword ##################################################### 
else if ($outputString == $keyword_JJ) {
	 
	 if ( $updateType == 'Addition' ) {
	 	   $data = '';
	 	   $message = $subscribeMessage_JJ;
	 	   $keyword = $keyword_JJ;
		   $sql = $dbh->prepare("INSERT INTO tbl_totalsubscribers(total_phoneno,total_keyword,total_date,total_time,total_status) VALUES (:phone,:keyword,:tarehe, :currtime,:status)");
		   $sql->bindParam(":phone", $number );   
  		   $sql->bindParam(":keyword", $keyword );
...
############################################### START of Message Saving to Database ##################################################### 
